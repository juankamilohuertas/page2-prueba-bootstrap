...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <div class="container-fluid px-2 px-md-4 px-lg-5">
        <a class="navbar-brand" href=""><img src="" alt="">Steje</a>
        ...
        <div class="collapse navbar-collapse" id="colapso">
            <div class="navbar-nav text-center w-100 mt-5 mt-sm-0">
                <a class="nav-link active mt-3 mt-sm-0 item_cursos" href="https://github.com/juankamilohuertas/plataformaStj/index.html#cursos">Cursos</a>
              <a class="nav-link" href="#">Novedades</a>
              <a class="nav-link" href="https://github.com/juankamilohuertas/plataformaStj/blog/blog.html">Blog</a>
